...
import com.wilddog.client.Wilddog.CompletionListener;
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Wilddog.ResultHandler resultHandler = new Wilddog.ResultHandler() {
                ...
                public void onSuccess() {
                    ref.authWithPassword(mEmail, mPassword, new Wilddog.AuthResultHandler(){
                        @Override
                        public void onAuthenticated(AuthData authData) {
                            SharedPreferences userInfo = getSharedPreferences("user",0);
                            SharedPreferences.Editor editor = userInfo.edit();
                            ...
                            update.put(authData.getUid(),info);
                            ref.child("users").updateChildren(update, new CompletionListener(){
            ...
            ref.createUser(mEmail, mPassword, resultHandler);
            return true;
        }
